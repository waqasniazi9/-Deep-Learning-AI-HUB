...
with st.sidebar:
    ...
    page = st.radio(
        "Navigate to:",
        ["🏠 Home", "📚 PyTorch Basics", "🖼️ Computer Vision",
...
if page == "🏠 Home":
    ...
    with col2:
        st.metric("🛠️ Tools", "50+", "interactive")
    with col3:
...
# ============= COMPUTER VISION =============
    ...
    with tab3:
        ...
        architectures = {
            "LeNet": ["Input (32×32)", "Conv (6,5×5)", "Pool", "Conv (16,5×5)", "Pool", "FC (120)", "FC (84)", "FC (10)"],
            "AlexNet": ["Input (227×227)", "Conv (96,11×11)", "Pool", "Conv (256,5×5)", "Pool", "Conv (384,3×3)", "Conv (384,3×3)", "Conv (256,3×3)", "Pool", "FC (4096)"],
            "VGG-16": ["Input", "2×Conv (64)", "Pool", "2×Conv (128)", "Pool", "3×Conv (256)", "Pool", "3×Conv (512)", "Pool", "3×Conv (512)", "Pool", "3×FC"],
            "ResNet-50": ["Input", "Conv+BN+ReLU", "4×Residual Block", "4×Residual Block", "4×Residual Block", "4×Residual Block", "Global Avg Pool", "FC"],
            "MobileNet": ["Input", "Depthwise Conv", "Pointwise Conv", "×14 bottleneck blocks", "Global Avg Pool", "FC"]
        }
...
# ============= DATA TOOLS =============
    ...
    with tab1:
        ...
        dataset_info = {
            "MNIST": {"images": 70000, "classes": 10, "size": "28×28", "format": "Grayscale"},
            "CIFAR-10": {"images": 60000, "classes": 10, "size": "32×32", "format": "RGB"},
        ...
        col2.metric("🏷️ Classes", info["classes"])
...
# ============= ADVANCED TOOLS =============
    ...
    with tab1:
        ...
        with col2:
            st.info(f"📊 Total Samples: {batch_size * num_batches}\n\n" +
                    f"🔄 Processing Time (est.): {batch_size * num_batches * 0.01:.2f}s\n\n" +
                    f"💾 Memory Usage (est.): {batch_size * num_batches * 0.001:.2f}MB")
